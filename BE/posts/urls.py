...
urlpatterns = [
    path('create/', PostCreateAPIView.as_view(), name='create_post'),                           # page 없이 포스트 생성    
    path('create/<int:page_id>/', PostCreateAPIView.as_view(), name='create_post_with_page'),   # 포스트 생성  
